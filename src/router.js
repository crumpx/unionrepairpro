...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/service/carrierunlock',
      name: 'carrierunlock',
      // route level code-splitting
      // this generates a separate chunk (about.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import(/* webpackChunkName: "about" */ './views/CarrierUnlock.vue')
    },
    {
      path: '/service/accountunlock',
      name: 'accountunlock',
      // route level code-splitting
      // this generates a separate chunk (about.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import(/* webpackChunkName: "about" */ './views/AccountUnlock.vue')
    },
    {
